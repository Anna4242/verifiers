...
def llm_tool_executor(tool_name: str, arguments: Dict[str, Any],
    ...
    # Create a focused prompt for tool execution
    system = f"""You are executing the tool '{tool_name}' with the given arguments.
Return ONLY the direct result value. No explanation, no formatting, just the answer."""
